...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _helipadCountAnimation = IntTween(begin: 0, end: 28).animate(_countController);
    _generationCountAnimation = IntTween(begin: 0, end: 6).animate(_countController);
          ...
          Padding(
            ...
            child: SlideTransition(
              position: Tween<Offset>(begin: const Offset(0, -1), end: Offset.zero).animate(
                  CurvedAnimation(parent: _containerAnimationController, curve: Curves.easeOut)),
              child: Row(
