...
//               NavigationDestination(icon: Icon(IconlyLight.wallet), label: ''),
//               NavigationDestination(icon: Icon(IconlyLight.location), label: ''),
//               NavigationDestination(
//                   icon: Icon(IconlyLight.time_circle), label: ''),
//               NavigationDestination(icon: Icon(IconlyLight.setting), label: ''),
//             ],
//           ),
//         ),
//       ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white.withOpacity(0.6), // Glassy effect
          borderRadius: BorderRadius.circular(100),
          boxShadow: [
            BoxShadow(
                color: Colors.black.withOpacity(0.1),
